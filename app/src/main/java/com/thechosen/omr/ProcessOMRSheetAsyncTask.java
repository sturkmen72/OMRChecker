...
import com.thechosen.omr.detection.DetectionUtil;
import com.thechosen.omr.drawing.DrawingUtil;
import com.thechosen.omr.evaluation.EvaluationUtil;
import com.thechosen.omr.exceptions.UnsupportedCameraResolutionException;
import com.thechosen.omr.main.R;
import com.thechosen.omr.object.OMRSheet;
import com.thechosen.omr.object.OMRSheetCorners;
import com.thechosen.omr.utils.PrereqChecks;
...
public class ProcessOMRSheetAsyncTask extends AsyncTask<Void, Void, Boolean> {
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if(omrSheetCorners == null){
            ...
            dialogOMRSheetDisplay.setNeutralButton(R.string.go_to_next, new DialogInterface.OnClickListener() {
